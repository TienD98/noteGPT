...
function mainApp() {
    ...
    return (
        <>
            {data ? data.map((item) => { return <ToastComponent key={item.id} id={item.id} title={item.title} note={item.note} offX={offsetX} offY={offsetY} dragging={isDragging} current={currentElement} /> }) : <p>loading notes</p>}
            {/* left side note bar */}
                ...
                <div className="offcanvas-body d-flex flex-column justify-content-between p-0">
                    <div>
                        ...
                        <div id='list-notes' className="list-group list-group-flush border-bottom scrollarea">
                            <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap" className="list-group-item list-group-item-action py-3 lh-tight" href="#/main">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form>
                                ...
                                <button type="submit" className="btn btn-primary newnote-button" >Add note</button>
                            </form>
                        </div>
                    </div>
                </div>
