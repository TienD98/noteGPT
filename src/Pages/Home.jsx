        ...
        <div>
            ...
            <section className="about">
                <div className="about p-2">
                    ...
                    <p className="about-p mb-2 fontColor">Hi there! I'm <span style={{ color: "#66FCF1", fontWeight: "bold" }}>Tien</span>, a recent
                ...
                <div className="container position-relative">
                    <div className="row mb-5">
                        <div className="col-md-8 col-xl-6 text-center mx-auto">
                            ...
                            <p className="text-center fontColor">I'm always eager to hear from the users of <span className='link-primary' style={{ fontFamily: "Aldrich, sans-serif", color: "#1F2833", fontWeight: "bold" }}>NoteGPT</span>. Whether it&#39;s feedback, inquiries, or collaboration opportunities, feel free to reach out. Here&#39;s how you can contact me</p>
                        </div>
                    </div>
                            ...
                            <div className="d-flex flex-column justify-content-center align-items-start h-100">
                                <div className="d-flex align-items-center p-3">
                                    ...
                                    <div className="px-2">
                                        ...
                                        <p className="mb-0 fontColor">+123456789</p>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center p-3">
                                    ...
                                    <div className="px-2">
                                        ...
                                        <p className="mb-0 fontColor">info@example.com</p>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center p-3">
                                    ...
                                    <div className="px-2">
                                        ...
                                        <p className="mb-0 fontColor">123 Example Street</p>
                                    </div>
                                </div>
                            </div>
                        </div>
