        ...
        <div className="rowsignin signinmain row">
            <div className="col-8 col-sm-6 col-md-5 col-lg-6 offset-2 mx-auto" id="login">
                ...
                <form className="p-4">
                    ...
                    <p className='text-start text-color'>User name</p><input id="user" className="form-control inputuser" type="text" />
                    <p className='text-start text-color'>Password</p><input id='pass' className="form-control" type="password" />
                    ...
                    <div className="btn-signin">
                        ...
                        <p className='pt-4 newUser'>new NoteGPT? <a href='#/register' style={{ textDecoration: "none", color: "#66FCF1" }}>Signup</a></p>
                    </div>
                </form>
            </div>
